<div>
    @push('tablenice-scripts')
        @include('tablenice::partials.scripts')
    @endpush

    <style>
        /* Custom Litepicker Dark Theme */
        .dark .litepicker {
        ...
        .dark .litepicker .container__months .month-item-header div,
        .dark .litepicker .container__months .month-item-header select {
        ...
        .dark .litepicker .day-item.is-selected {
        ...
        .dark .litepicker .time-input input {
            background-color: theme('colors.slate.700');
            color: theme('colors.slate.200');
        }
    </style>
                ...
                <div class="flex items-center w-full gap-3 lg:w-auto lg:flex-1">
                    ...
                    <div class="relative w-full lg:max-w-md">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none z-10">
                            <x-tablenice-icon name="heroicon-s-magnifying-glass" @class(['w-5 h-5', $this->theme['text']]) />
                        </div>
                                                            ...
                                                            <div class="py-1">
                                                                @foreach ($this->table->actions() as $action)
                                                                    <a href="#"
                                                                        ...
                                                                        @if ($action->getIcon())
                                                                            <x-tablenice-icon :name="$action->getIcon()->value" class="w-4 h-4" />
                                                                        @endif
                                                                        <span>{{ $action->getLabel() }}</span>
                                                                    </a>
                                                                @endforeach
